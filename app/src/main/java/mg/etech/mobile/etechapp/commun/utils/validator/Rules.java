...
public final class Rules {
	...
	// Regular Expressions
	private static final String GOOD_IRI_CHAR = "a-zA-Z0-9\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF"; // android.util.Patterns.java
	private static final String TOP_LEVEL_DOMAIN_STR_FOR_WEB_URL = "(?:"
			...
			+ "|y[etu]" + "|z[amw]))"; // android.util.Patterns.java
	...
	public static final String REGEX_IP_ADDRESS = "((25[0-5]|2[0-4][0-9]|[0-1][0-9]{2}|[1-9][0-9]|[1-9])\\.(25[0-5]|2[0-4]"
			+ "[0-9]|[0-1][0-9]{2}|[1-9][0-9]|[1-9]|0)\\.(25[0-5]|2[0-4][0-9]|[0-1]"
			+ "[0-9]{2}|[1-9][0-9]|[1-9]|0)\\.(25[0-5]|2[0-4][0-9]|[0-1][0-9]{2}"
			+ "|[1-9][0-9]|[0-9]))"; // android.util.Patterns.java

	public static final String REGEX_WEB_URL = "((?:(http|https|Http|Https|rtsp|Rtsp):\\/\\/(?:(?:[a-zA-Z0-9\\$\\-\\_\\.\\+\\!\\*\\'\\(\\)"
	...
	public static final String REGEX_DATE = "(0?[1-9]|[12][0-9]|3[01]) (janvier|février|mars|avril|mai|juin|juillet|août|septembre|octobre|novembre|décembre) ((19|20)\\d\\d)";
	 ...
	 * @return
	 */
	public static Rule<TextView> date(final String failureMessage,
			final String regex, final boolean trimInput) {
		if (regex == null) {
			throw new IllegalArgumentException("\'regex\' cannot be null");
		}
